...
module.exports = {
  data: {
    name: "lock",
    description:
      "Bloquea un canal para los miembros / Lock a channel for members"
  },
  ...
  async execute(message) {
    ...
    const messages = {
      es: {
        ...
        notTextChannel: "-# Solo puedes bloquear canales de texto.",
        success: (channel) =>
          `-# El canal ${channel} ha sido bloqueado para todos los miembros.`,
        error: "-# Ocurrió un error al intentar bloquear el canal."
      },
      en: {
        noPermission: "-# You don't have permission to use this command.",
        notTextChannel: "-# You can only lock text channels.",
        success: (channel) =>
          `-# The channel ${channel} has been locked for all members.`,
        error: "-# An error occurred while trying to lock the channel."
      }
    };
    ...
    collector.on("collect", async (interaction) => {
      ...
      try {
        // Cambia los permisos del canal para que los miembros no puedan enviar mensajes
